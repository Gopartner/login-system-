...
const SidebarMenu = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    ...
    >
     ...
     <ul className="mt-4 space-y-4">               <NavLinkItem                                  to="/"                                      label="Home"                                icon={() => <FontAwesomeIcon icon={faHome} />}                                          onClick={toggleSidebar} // Event ditambahkan di sini
      />
      <NavLinkItem
        to="/about"
        label="About"
      ...
      <NavLinkItem
        ...
        onClick={toggleSidebar}
      /> 
	  <NavLinkItem                                  to="data-display"                           label="Data Display"                        icon={() => <FontAwesomeIcon icon={faEnvelope} />}                                      onClick={toggleSidebar}                   />
	  <NavLinkItem
	   to="shopping"
	   label="Shopping"
	   icon={() => <FontAwesomeIcon icon={faEnvelope} />}
